...
algorithm for computing them* (`paper/`). It reproduces the published table and reports **nine new terms, g(378) through g(387)**,
...
g(387) = 17088927744279024569389598842319
```
...
| `evidence/NEW_TERMS.md` | per-block certification ledger for g(378)-g(387): wheel, modulus, survivor counts per tier, SHA-256 per block. |
