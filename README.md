...
algorithm for computing them* (`paper/`). It reproduces the published table and reports **six new terms, g(378) through g(383)**,
...
| `evidence/NEW_TERMS.md` | per-block certification ledger for g(378)-g(383): wheel, modulus, survivor counts per tier, SHA-256 per block. |
